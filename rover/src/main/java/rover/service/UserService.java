...
public class UserService {
    ...
    public FinalResponse drop(Instructions instructions) {
        ...
        if(collision == 1){ 
            finalResponse.setFinalPos1("Stoped at (" + posRover1[0] + " " + posRover1[1] + " " + posRover1[2] + ") to avoid colision");
        }
        ...
        if(collision == 1){ 
            finalResponse.setFinalPos2("Stoped at (" + posRover2[0] + " " + posRover2[1] + " " + posRover2[2] + ") to avoid colision");
        }
